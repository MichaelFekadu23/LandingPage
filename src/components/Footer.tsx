...
export default function Footer({
  ...
  return (
    <footer className="bg-white dark:bg-black text-[rgba(26,26,26,0.9)] dark:text-white pt-14">
      <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6">
        {/* Top rule */}
        <hr className="border-[#E0E0E0] dark:border-[#232323]" />
        {/* Row: logo, nav, social */}
        <div className="flex flex-col gap-6 py-8 md:flex-row md:items-center md:justify-between md:py-9">
          {/* Logo */}
          <div className="flex items-center justify-center gap-3 md:justify-start">
            <img
              src={!isDark ? logoSrc : "/assets/logo-new.svg"}
              alt="MOTO"
          ...
          {/* Social pill */}
          <div className="mx-auto flex items-center gap-3 rounded-xl border border-[rgba(224,224,224,1)] dark:border-[#232323] px-3 py-2 sm:px-4 sm:py-3 md:mx-0">
